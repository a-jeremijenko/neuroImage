...
fmri_data_table = [
    {'subject': 'sub-01',
     'data_file': './data/mri/sub-01_perceptionNaturalImageTest_original_VC.h5',
     'roi_selector': 'ROI_VC = 1',
     'output_dir': './lmdb/sub-01-test'},
    {'subject': 'sub-02',
     'data_file': './data/mri/sub-02_perceptionNaturalImageTest_original_VC.h5',
     'roi_selector': 'ROI_VC = 1',
     'output_dir': './lmdb/sub-02-test'},
    {'subject': 'sub-03',
     'data_file': './data/mri/sub-03_perceptionNaturalImageTest_original_VC.h5',
     'roi_selector': 'ROI_VC = 1',
     'output_dir': './lmdb/sub-03-test'}
]
# Image data
...
for i in range(1, 4):
    with open(f'lmdb/sub-0{i}-test/fmri.pkl', 'rb') as f:
        fmri_raw = pickle.load(f)

    with open(f'lmdb/sub-0{i}-test/images.pkl', 'rb') as f:
    ...
    np.save(f'./np_data/sub_0{i}_images_test.npy', images_concat, allow_pickle=True, fix_imports=True)
    np.save(f'./np_data/sub_0{i}_fmri_test.npy', fmri_concat, allow_pickle=True, fix_imports=True)
    np.save(f'./np_data/sub_0{i}_labels_test.npy', labels_concat, allow_pickle=True, fix_imports=True)
